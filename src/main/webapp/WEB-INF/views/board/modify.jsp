...
<h1>조회 페이지</h1>
	...
	<form id="modify_form" action="/board/modify" method="post">
		...
		<div class="input_wrap">
			<label>게시판 내용</label>
			<textarea rows="3" name="content" id="c"><c:out value="${pageInfo.content}"/></textarea>
		</div>
		<div class="input_wrap">
			<label>게시판 작성자</label>
...
let mForm = $("#modify_form");
    ...
    $("#cancel_btn").on("click", function(e){
    	detailF.attr("action", "/board/details");
    	detailF.submit();
    });
	...
	$('#delete_btn').on("click",function(){
		...
		detailF.attr("action","/board/delete");
		detailF.attr("method","post");
		detailF.submit();
