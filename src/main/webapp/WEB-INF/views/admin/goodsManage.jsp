...
<link rel="stylesheet" href="../resources/admin/goodsManage.css">
	                    ...
	                    <div class="goods_table_wrap">
		                    ...
		                    <c:if test="${listcheck != 'empty'}">
		                    	<table class="goods_table">
		                    		...
		                    		<tr>
		                    			<td>
		                    				<a class="move" href='<c:out value="${list.goods_NO}"/>'>
		                    					<c:out value="${list.goods_NO}"></c:out>
		                    				</a>	
		                    			</td>
		                    			<td><c:out value="${list.goods_NM}"></c:out></td>
		                    			<td><c:out value="${list.cate_NM}"></c:out></td>
		                    			<td><c:out value="${list.stock}"></c:out></td>
		                    			<td><fmt:formatDate value="${list.create_DT}" pattern="yyyy-MM-dd"/></td>
		                    		</tr>
		                    		</c:forEach>
		                    	</table>
		                    </c:if>
...
$(".move").on("click", function(e){
	...
	moveForm.append("<input type='hidden' name='goods_NO' value='"+$(this).attr("href") + "'>");
